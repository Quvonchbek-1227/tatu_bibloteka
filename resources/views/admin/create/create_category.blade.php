...
<div class="row page-titles mx-0">
    <div class="col-sm-6 p-md-0">
        <div class="welcome-text">
            <h4>Bosh Sahifaga Slayd Qo`shish
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6">
                            <div class="form-group d-flex flex-column">
                                <label class="form-label">Bu kategoriya haqida malumot(qisqa)</label>
                                <textarea name="description" required id="summernote" cols="30" rows="10"></textarea>
                            </div>
                        </div>
